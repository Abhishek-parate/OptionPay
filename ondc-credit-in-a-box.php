...
<!-- End Google Tag Manager (noscript) -->
  ...
  <main>
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16" data-aos="fade-up" data-aos-duration="600" data-aos-delay="400">
          ...
          <div class="flex flex-col items-start">
            <!-- Icon Section -->
            <div class="bg-secondary-100 rounded-lg mb-4">
              <img src="./assets/images/odnc-credit-box/icon1.svg" alt="Banking Services" />
            </div>

            <!-- Content Section -->
            <div>
              <h3 class="text-xl font-semibold text-secondary-500 mb-2">Banking Services</h3>
          ...
          <div class="flex flex-col items-start">
            ...
            <!-- Content Section -->
            <div>
              <h3 class="text-xl font-semibold text-secondary-500 mb-2">Travel Solutions</h3>
          ...
          <div class="flex flex-col items-start">
            ...
            <!-- Content Section -->
            <div>
              <h3 class="text-xl font-semibold text-secondary-500 mb-2">Bill Payment Hub</h3>
          ...
          <div class="flex flex-col items-start">
            ...
            <!-- Content Section -->
            <div>
              <h3 class="text-xl font-semibold text-secondary-500 mb-2">E-Governance Tools</h3>
          ...
          <div class="flex flex-col items-start">
            ...
            <!-- Content Section -->
            <div>
              <h3 class="text-xl font-semibold text-secondary-500 mb-2">ONDC Services</h3>
          ...
          <div class="flex flex-col items-start">
            ...
            <!-- Content Section -->
            <div>
              <h3 class="text-xl font-semibold text-secondary-500 mb-2">Wealth Management</h3>
        ...
        <div class="flex justify-center mt-16" data-aos="fade-up" data-aos-duration="600" data-aos-delay="400">
          <a href="book-a-demo"
            class="bg-secondary-500 text-white font-medium py-3 px-8 rounded-md transition duration-300">
    ...
    <section class="bg-white py-10 ">
      ...
      <div class="w-full bg-secondary-500 py-12 mb-24">
        <!-- Section heading -->
