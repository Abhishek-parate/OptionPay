...
<head>
  ...
  <title>Fastag Recharge Services | OptionPay</title>
  <meta name="description" content="Offer Fastag recharges with OptionPay. Provide instant top-ups for all bank Fastags from your store.">
          ...
          <div class="flex flex-col md:flex-row md:items-center">
            ...
            <div class="p-4 md:p-8 lg:p-12 pt-8" data-aos="fade-right" data-aos-duration="1000"
              ...
              <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-secondary-500 mb-3 sm:mb-4" data-aos="fade-up"
                ...
                Make Every Drive Count:<br class="hidden md:hidden lg:block"> Your Simple FASTag Solution
              </h1>
              <p class="black mb-6 sm:mb-8 text-sm sm:text-base" data-aos="fade-up" data-aos-delay="400"
                data-aos-duration="800" data-aos-once="true">
                Offer instant FASTag recharge services at your <br class="hidden md:hidden lg:block">
    ...
    <section class="bg-secondary-100 py-12 px-4 md:px-24" data-aos="fade" data-aos-duration="800"
      ...
      <div class="container mx-auto px-6">
        <h2 class="text-3xl font-bold text-primary-700 my-8 text-center" data-aos="fade-up"
          ...
          Why Choose OptionPay <span class="text-secondary-500">FASTag Platform</span>
        </h2>
