...
<head>
  ...
  <title>Aadhar Pay Service Provider | OptionPay</title>
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap" rel="stylesheet">
  <link href="./assets/css/style.css" rel="stylesheet">
  <link href="./assets/css/header.css" rel="stylesheet">
  <link rel="stylesheet" href="./assets/css/text-scroll.css">
...
<body class="bg-white font-inter">
  ...
  <main>
        ...
        <div class="rounded-xl overflow-hidden">
          <div class="flex flex-col md:flex-row md:items-center gap-6 md:gap-4 lg:gap-0">
            ...
            <div class="p-4 md:p-8 lg:p-12 pt-8 md:w-1/2" data-aos="fade-right" data-aos-duration="1000"
              ...
              <a href="book-a-demo"
                class="inline-flex items-center justify-center px-4 sm:px-5 py-2 sm:py-3 bg-secondary-500 text-white rounded-lg font-semibold text-sm transition-all hover:-translate-y-0.5 hover:shadow-lg mb-6 sm:mb-4"
        ...
        <div class="relative w-full overflow-hidden h-6">
          <div class="absolute flex whitespace-nowrap infinite-scroll">
            ...
            <div class="flex space-x-6">
              <span class="px-4 border-l border-white">Biometric Transactions</span>
              <span class="px-4 border-l border-white">Direct Bank Transfers</span>
              <span class="px-4 border-l border-white">Real-time Processing</span>
            </div>
    ...
    <section class="py-12  mt-6" data-aos="fade-up">
      <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="rounded-lg border border-secondary-500 hover:bg-secondary-100 p-6" data-aos="zoom-in"
            data-aos-delay="100">
          ...
          <div class="rounded-lg border border-secondary-500 hover:bg-secondary-100 p-6" data-aos="zoom-in" data-aos-delay="200">
          ...
          <div class="rounded-lg border border-secondary-500 hover:bg-secondary-100 p-6" data-aos="zoom-in" data-aos-delay="300">
    ...
    <section class="w-full lg:py-12 md:py-3">
      <div class="max-w-6xl mx-auto px-4">
    ...
    <section class="w-full py-12" style="background-color:#22aa47;" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
      ...
      <div class="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-center text-white px-4">
        ...
        <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="300" data-aos-once="true">
          <div class="text-4xl sm:text-5xl font-bold counter">
            <span id="bank-count">20</span><span>+</span>
          </div>
    ...
    <section class="relative py-10 px-4 sm:px-8 md:px-16 lg:px-20">
      <div class="container mx-auto">
        ...
        <div class="bg-gradient-to-br from-secondary-700 to-secondary-500 rounded-xl p-6 sm:p-8 md:p-10 text-white relative overflow-hidden"
