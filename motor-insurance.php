...
<head>
  ...
  <title>Motor Insurance Services | OptionPay</title>
  <meta name="description" content="Offer motor insurance policies with OptionPay. Provide coverage for two-wheelers, cars, and commercial vehicles.">
...
<body class="bg-white font-inter">
  ...
  <main class="overflow-hidden">
          ...
          <div class="flex flex-col md:flex-row md:items-center">
            ...
            <div class="p-4 md:p-8 lg:p-10 pt-8 md:w-2/5" data-aos="fade-right" data-aos-duration="1000"
              ...
              <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-secondary-500 mb-3 sm:mb-4" data-aos="fade-up"
                ...
                Simplify Utility Payments<br class="hidden md:hidden lg:block"> Through Your Business
              </h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-8">
            ...
            <div class="text-left mb-2">
              <h2 class="text-xl font-semibold text-primary-500">Quick Policy Issuance</h2>
            </div>
          ...
          <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-8">
            <!-- Icon and Title - Vertical Alignment -->
            <div class="text-left mb-2">
              <h2 class="text-xl font-semibold text-primary-500">Multiple Insurance Partners</h2>
            </div>
            <ul class="list-disc pl-5 space-y-2 text-gray-700">
          ...
          <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-8">
            <!-- Icon and Title - Vertical Alignment -->
            <div class="text-left mb-2">
              <h2 class="text-xl font-semibold text-primary-500">Simple Claims Process</h2>
            </div>
            <ul class="list-disc pl-5 space-y-2 text-gray-700">
                  ...
                  <ul class="space-y-5 mb-8">
                    ...
                    ?>
                      <li class="flex items-start">
                        ...
                        <span class="ml-3 text-secondary-300"><?php echo $plan; ?></span>
                      </li>
                    <?php endforeach; ?>
                  </ul>
                </div>
    ...
    <div class="w-full overflow-hidden py-2 bg-primary-700 ">
      <div class="max-w-7xl mx-auto flex items-center space-x-6 px-4 py-12 text-white">
        <p class="font-semibold whitespace-nowrap">Partner Support:</p>
        <div class="relative w-full overflow-hidden h-6">
          <div class="absolute flex whitespace-nowrap infinite-scroll">
            ...
            <div class="flex space-x-6">
              ...
              <span class="px-4 border-l border-white">Marketing collateral</span>
              <span class="px-4 border-l border-white">Regular training sessions</span>
            </div>
