  ...
  <main class="overflow-hidden">
          ...
          <div class="flex flex-col md:flex-row md:items-center">
            ...
            <div class="relative mx-auto px-4 sm:px-0" data-aos="fade-left" data-aos-duration="1200"
              ...
              <div class="relative z-20">
                <img src="assets/images/ondc-credit-service-platform/hero.png" alt="Dashboard"
                  class="w-full h-auto" />
                <div
    ...
    <section class="bg-secondary-100 py-10 px-4 md:px-24 flex items-center">
      <div class="container mx-auto px-4 md:px-6">
        <h2 class="text-3xl font-bold text-primary-500 mb-8 text-primary-500 text-center" data-aos="zoom-in"
      ...
      <div class="tab-pane block opacity-100 transition-opacity duration-300" id="aeps">
        <div class="flex flex-col md:flex-row items-center gap-8">
          ...
          <div class="w-full md:w-1/2" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
            <h3 class="text-4xl font-bold mb-5 text-black text-primary-600">
