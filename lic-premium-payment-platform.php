...
<head>
  ...
  <title>LIC Premium Payment Platform | OptionPay</title>
  <meta name="description" content="Help customers pay LIC premiums with OptionPay. Offer instant processing and digital receipts from your shop.">
...
<body class="bg-white font-inter">
  ...
  <main class="overflow-hidden">
          ...
          <div class="flex flex-col md:flex-row md:items-center">
            ...
            <div class="p-4 md:p-8 lg:p-12 pt-8" data-aos="fade-right" data-aos-duration="1000"
              ...
              <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-secondary-500 mb-3 sm:mb-4" data-aos="fade-up"
                ...
                A reliable digital solution for <br class="hidden md:hidden lg:block">LIC premium collections </h1>
              <p class="black mb-6 sm:mb-8 text-sm sm:text-base" data-aos="fade-up" data-aos-delay="400"
                data-aos-duration="800" data-aos-once="true">
                Transform your store into a trusted LIC premium collection center. Help <br class="hidden md:hidden lg:block">customers
                pay their insurance premiums easily while earning <br class="hidden md:hidden lg:block"> commission on each transaction.
              </p>
    ...
    <section class="w-full py-10 px-4" data-aos="fade" data-aos-duration="800" data-aos-once="true">
