...
<head>
  ...
  <title>Domestic Money Transfer Service | OptionPay</title>
  <meta name="description" content="Provide instant domestic money transfers with OptionPay. Enable secure bank-to-bank payments from your store.">
  <meta name="keywords" content="domestic money transfer, OptionPay">
...
<body class="bg-white font-inter">
  ...
  <main class="overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 md:py-12 relative z-10">
        <div class="rounded-xl overflow-hidden">
          <div class="flex flex-col md:flex-row md:items-center">
            ...
            <div class="px-2 pt-8 md:px-12 md:pt-12 lg:px-16 lg:pt-16" data-aos="fade-right" data-aos-duration="1000">
              <p class="font-semi-bolder text-primary-600 font-bold mt-2">DMT - Domestic Money transfer</p>
              <h1 class="text-2xl md:text-4xl font-bold text-secondary-500 mb-2">Money Transfer <br class="hidden md:hidden lg:block"> Platform</h1>
              ...
              <div class="flex items-center gap-2 border-2 md:mt-4 border-gray-200 rounded-full p-1 w-full max-w-sm shadow-sm">
                <div class="flex -space-x-2">
                  ...
                  <img src="https://randomuser.me/api/portraits/men/3.jpg" class="w-6 h-6 sm:w-8 sm:h-8 md:w-8 md:h-8 rounded-full border-2 border-white">
                  <img src="https://randomuser.me/api/portraits/women/4.jpg" class="w-6 h-6 sm:w-8 sm:h-8 md:w-8 md:h-8 rounded-full border-2 border-white">
                </div>
    ...
    <section class="py-12 mt-6 bg-primary-100">
      <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="rounded-lg border hover:bg-primary-200 p-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
          ...
          <div class="rounded-lg border hover:bg-primary-200 p-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
          ...
          <div class="rounded-lg border hover:bg-primary-200 p-6" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
    ...
    <section class="bg-primary-600 py-10 px-4 md:px-24">
      <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <!-- Feature Card 4 -->
          <div class="border border-gray-200 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">
            <img src="assets/images/dmt/settlement-system.png" alt="Real-Time Payment" class="w-full object-contain rounded-t-lg">
            <div class="p-6 text-left">
              <h3 class="text-secondary-600 font-semibold text-xl mb-2">Settlement System</h3>
              <p class="text-gray-600 text-sm">
                Receive settlements directly in your account. Our automated system ensures timely payouts.
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="w-full py-12" data-aos="fade-up" data-aos-duration="1000">
      <div class="max-w-6xl mx-auto px-4">
        <div class="flex flex-col md:flex-row items-center gap-8">
          <!-- Left side with illustration -->
          <div class="w-full md:w-1/2">
            <img src="assets/images/dmt/benefits.png" alt="Life Insurance" class="w-full max-w-md mx-auto object-contain">
          </div>
            ...
            <ul class="space-y-5 mb-8">
              ...
              ?>
                <li class="flex items-center">
                  ...
                  <span class="ml-3 text-gray-700 text-sm md:text-base"><?php echo $dmt; ?></span>
                </li>
              <?php endforeach; ?>
            </ul>
            <a href="book-a-demo"
      ...
      <div class="space-y-4">
        ...
        $faqItems = [
          [
            ...
            'answer' => 'DMT (Domestic Money Transfer) is a secure platform that enables money transfers between bank accounts within India. Its designed for ers to offer quick transfer services to customers.',
            'isOpen' => true
          ],
          [
