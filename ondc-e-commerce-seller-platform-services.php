...
<!-- End Google Tag Manager (noscript) -->
  ...
  <main class="overflow-hidden">
          ...
          <div class="flex flex-col md:flex-row md:items-center">
            ...
            <div class="p-4 md:p-8 lg:p-12 pt-8" data-aos="fade-right" data-aos-duration="1000"
              ...
              <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-secondary-500 mb-3 sm:mb-4" data-aos="fade-up"
                ...
                Serve Buyers with Local<br class="hidden md:hidden lg:block"> Convenience
              </h1>
    ...
    <section class="bg-secondary-100 py-10 px-4 md:px-24 flex items-center">
                          ...
                          <div
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                              ...
                              <circle cx="12" cy="12" r="10" stroke="#22aa47" stroke-width="2"
                                fill="none" />
                              <path d="M7 12.5L10 15.5L17 8.5" stroke="#22aa47"
      ...
      <div class="space-y-4">
        ...
        $faqItems = [
          ...
          [
            ...
            'answer' => 'Partner with OptionPay to onboard sellers. Once registered, sellers can list their products and start reaching customers through the ONDC network.',
            'isOpen' => false
          ],
          [
          ...
          [
            ...
            'answer' => 'Payments are processed through the ONDC system and settled directly into the seller’s bank account. Sellers can view detailed transaction reports and track settlements through the OptionPay dashboard.',
            'isOpen' => false
          ]
        ];
